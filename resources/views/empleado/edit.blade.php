...
<div class="container">
    ...
    <!-- Creamos un formulario para actualizar la informacion -->
    ...
    <!-- $empleado->id = obtenemos el id del dato que queremos actualizar -->
    ...
    <!-- {{ method_field('PATCH') }} = agregamos el metodo por el cual enviamos la informacion -->

    <!-- method_field() = permite elegir un metodo HTTP, por el cual enviamos la informacion -->

    <!-- PATCH = este es el metodo por el cual se va a enviar la informacion y hace referencia al metodo 
                "empleado.update", que nos muestra al ejecutar el comando "php artisan route:list" 
                con este metodo vamos a actualizar la iformacion -->
    ...
    <!-- ['modo'=>'Editar'] = usamos esta instruccion para crear una variable, la cual va a permitir, indicarle al
    ...
    <!-- 'Editar' = este es el valor de la variable y que va mostrar nuestro boton -->
